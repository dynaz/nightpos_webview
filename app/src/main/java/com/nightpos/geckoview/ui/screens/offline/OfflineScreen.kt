package com.nightpos.geckoview.ui.screens.offline
...
import com.nightpos.geckoview.ui.theme.NightSurface
import com.nightpos.geckoview.ui.theme.TextSecondary

/**
 * Full-screen "no internet" state shown whenever [com.nightpos.geckoview.data.NetworkConnectivityObserver]
 * reports the device is offline. Includes a manual retry button; the host screen
 * also auto-retries as connectivity returns (see [com.nightpos.geckoview.ui.screens.webview.WebViewScreen]).
 */
@Composable
fun OfflineScreen(
    onRetry: () -> Unit,
